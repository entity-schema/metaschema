...
export type StringMetaschema = (
  StringTypeMetaschema & NoNumberKeywordsMetaschema &
  NoObjectKeywordsMetaschema & NoArrayKeywordsMetaschema
)
...
export interface NumericTypeInclusiveMinimumMetaschema
extends NumericTypeMetaschema {
  minimum?: number
  exclusiveMinimum?: never
}

export interface NumericTypeExclusiveMinimumMetaschema
extends NumericTypeMetaschema {
  minimum?: never
  exclusiveMinimum?: number
}

export interface NumericTypeInclusiveMaximumMetaschema
extends NumericTypeMetaschema {
  maximum?: number
  exclusiveMaximum?: never
}

export interface NumericTypeExclusiveMaximumMetaschema
extends NumericTypeMetaschema {
  maximum?: never
  exclusiveMaximum?: number
}

export type NumericTypeMinimumMetaschema = (
  NumericTypeInclusiveMinimumMetaschema | NumericTypeExclusiveMinimumMetaschema
)

export type NumericTypeMaximumMetaschema = (
  NumericTypeInclusiveMaximumMetaschema | NumericTypeExclusiveMaximumMetaschema
)

export type NumericTypeRangedMetaschema = (
  NumericTypeMinimumMetaschema & NumericTypeMaximumMetaschema
)
...
export type NumberMetaschema = (
  NumberTypeMetaschema & NumericTypeRangedMetaschema & NotStringMetaschema &
  NoObjectKeywordsMetaschema & NoArrayKeywordsMetaschema
)
...
export type IntegerMetaschema = (
  IntegerTypeMetaschema & NumericTypeRangedMetaschema & NotStringMetaschema &
  NoObjectKeywordsMetaschema & NoArrayKeywordsMetaschema
)
...
export type ObjectMetaschema = (
  ObjectTypeMetaschema & NotStringMetaschema & NoNumberKeywordsMetaschema &
  NoArrayKeywordsMetaschema
)
...
export type ArrayMetaschema = (
  NotStringMetaschema & NoNumberKeywordsMetaschema &
  NoObjectKeywordsMetaschema & (
    ArrayAnyMetaschema | ArrayOfMetaschema | ArrayTupleMetaschema
  )
)
...
export type BooleanMetaschema = (
  BooleanTypeMetaschema & NotStringMetaschema & NoNumberKeywordsMetaschema &
  NoObjectKeywordsMetaschema & NoArrayKeywordsMetaschema
)
...
export type NullMetaschema = (
  BooleanTypeMetaschema & NotStringMetaschema & NoNumberKeywordsMetaschema &
  NoObjectKeywordsMetaschema & NoArrayKeywordsMetaschema
)

export type TypedMetaschema = (
  StringMetaschema | NumberMetaschema | IntegerMetaschema | ObjectMetaschema |
  ArrayMetaschema | NullMetaschema
)
...
export type CombiningMetaschema = (
  AllOfMetaschema | AnyOfMetaschema | OneOfMetaschema | NotMetaschema
)
...
export type Metaschema = JSONSchema6 | boolean
